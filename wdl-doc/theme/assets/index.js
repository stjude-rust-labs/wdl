...
var ShikiError2, alignUp, __defProp2, __defNormalProp, __publicField, onigBinding, UtfString, _OnigString, OnigString, OnigScanner, initPromise, _defaultWasmLoader;
var init_dist2 = __esm({
  "node_modules/@shikijs/engine-oniguruma/dist/index.mjs"() {
    ShikiError2 = class extends Error {
      constructor(message) {
        super(message);
        this.name = "ShikiError";
      }
    };
    alignUp = (x, multiple) => x + (multiple - x % multiple) % multiple;
...
var _emitDeprecation, _emitError;
var init_core_Bn_XU0Iv = __esm({
  "node_modules/@shikijs/core/dist/shared/core.Bn_XU0Iv.mjs"() {
    _emitDeprecation = false;
    _emitError = false;
  }
});
...
var CAPTURING_REGEX_SOURCE, RegexSource, CachedFn, Theme, ScopeStack, StyleAttributes, ParsedThemeRule, FontStyle, ColorMap, emptyParentScopes, ThemeTrieElementRule, ThemeTrieElement, EncodedTokenMetadata, TopLevelRuleReference, TopLevelRepositoryRuleReference, ExternalReferenceCollector, ScopeDependencyProcessor, BaseReference, SelfReference, RelativeReference, TopLevelReference, TopLevelRepositoryReference, HAS_BACK_REFERENCES, BACK_REFERENCING_END, ruleIdSymbol, endRuleId, whileRuleId, Rule, CaptureRule, MatchRule, IncludeOnlyRule, BeginEndRule, BeginWhileRule, RuleFactory, RegExpSource, RegExpSourceList, CompiledRule, BasicScopeAttributes, BasicScopeAttributesProvider, ScopeMatcher, DebugFlags, UseOnigurumaFindOptions, TokenizeStringResult, LocalStackElement, Grammar, AttributedScopeStack, StateStackImpl, BalancedBracketSelectors, LineTokens, SyncRegistry, Registry, INITIAL;
var init_dist3 = __esm({
  "node_modules/@shikijs/vscode-textmate/dist/index.js"() {
    CAPTURING_REGEX_SOURCE = /\$(\d+)|\${(\d+):\/(downcase|upcase)}/g;
    RegexSource = class {
    ...
    emptyParentScopes = Object.freeze([]);
    ...
    EncodedTokenMetadata = class _EncodedTokenMetadata {
    ...
    HAS_BACK_REFERENCES = /\\(\d+)/;
    BACK_REFERENCING_END = /\\(\d+)/g;
    ruleIdSymbol = Symbol("RuleId");
    endRuleId = -1;
    whileRuleId = -2;
    Rule = class {
      $location;
    ...
    AttributedScopeStack = class _AttributedScopeStack {
      /**
       * Invariant:
       * ```
...
var own2, characters, key, notAlphanumericRegex;
...
var emptyOptions, emptyCharacterReferences, emptyChildren2;
var init_lib3 = __esm({
  "node_modules/hast-util-to-html/lib/index.js"() {
...
var ShikiError3, _grammarStateMap, GrammarState, builtInTransformers, namedColors, decorations, defaultNamedColorsMap, VSCODE_FALLBACK_EDITOR_FG, VSCODE_FALLBACK_EDITOR_BG, RESOLVED_KEY, Registry2, Resolver, instancesCount;
var init_dist4 = __esm({
  "node_modules/@shikijs/core/dist/index.mjs"() {
    ...
    ShikiError3 = class extends Error {
      constructor(message) {
        super(message);
        this.name = "ShikiError";
      }
    ...
    VSCODE_FALLBACK_EDITOR_FG = { light: "#333333", dark: "#bbbbbb" };
    VSCODE_FALLBACK_EDITOR_BG = { light: "#fffffe", dark: "#1e1e1e" };
    RESOLVED_KEY = "__shiki_resolved";
    Registry2 = class extends Registry {
      ...
      loadLanguages(langs) {
        ...
        if (missingLangs.length) {
          const dependents = langsGraphArray.filter(([_, lang2]) => lang2 && lang2.embeddedLangs?.some((l) => missingLangs.map(([name]) => name).includes(l))).filter((lang2) => !missingLangs.includes(lang2));
...
// sprocket-code.utils.js
var sprocket_code_utils_exports = {};
__export(sprocket_code_utils_exports, {
...
async function initializeHighlighter() {
  ...
  try {
    ...
    const languagesToLoad = [rust_default];
    ...
    const highlighter = await createHighlighterCore({
      themes: [catppuccin_mocha_default],
...
var wdlGrammarCache, WDL_GRAMMAR_URL;
var init_sprocket_code_utils = __esm({
  "sprocket-code.utils.js"() {
    init_core2();
    ...
    init_wasm();
    wdlGrammarCache = null;
    WDL_GRAMMAR_URL = "https://raw.githubusercontent.com/stjude-rust-labs/sprocket-vscode/refs/heads/main/syntaxes/wdl.tmGrammar.json";
  }
});

// sprocket-code.js
var SprocketCode = class extends HTMLElement {
  constructor() {
    super();
  ...
  async connectedCallback() {
    try {
      const { initializeHighlighter: initializeHighlighter2 } = await Promise.resolve().then(() => (init_sprocket_code_utils(), sprocket_code_utils_exports));
      const highlighter = await initializeHighlighter2();
      ...
      this.shadowRoot.innerHTML = `
        ...
        <div class="code-block">${html5}</div>
      `;
    } catch {
    }
  }
...
// sprocket-tooltip.js
var SprocketTooltip = class extends HTMLElement {
  constructor() {
    super();
    this.attachShadow({ mode: "open" });
  }
