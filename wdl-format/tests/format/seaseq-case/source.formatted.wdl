...
bowtie_index
    ...
    Array[
    File
    ] actual_bowtie_index = select_first(
    [
...
spikein_bowtie_index
                    ...
                    Array[
                    File
                    ] int_spikein_bowtie_index = select_first(
                    [
                        spikein_bowtie_index,
                        string_spikein_buffer,
...
Array[
File
] actual_spikein_bowtie_index = select_first(
[
...
sample_fastq
    ...
    Array[
    File
    ] sample_fastqfile = s_fastq

}

Array[
File
] original_fastqfiles = flatten(
select_all(
[
    sample_srafile,
    sample_fastqfile,
...
Boolean multi_fastq = (
    ...
    Boolean one_fastq = (
        ...
        spikein_reference
                        ...
                        scatter (
                        eachfastq in original_fastqfiles
                        ) {
                        ...
                        Array[
                        File
                        ] spikein_fastqfiles = spikein_indv_map.unaligned

                }

                Array[
                File
                ] fastqfiles = select_first(
                [
                    spikein_fastqfiles,
                    original_fastqfiles,
...
input: bedfile = finalbed.bedfile
}
...
output {
            ...
            Array[
            File?
            ]? indv_s_htmlfile = indv_fastqc.htmlfile

            Array[
            File?
            ]? indv_s_zipfile = indv_fastqc.zipfile
            ...
            Array[
            File?
            ]? s_metrics_out = indv_bfs.metrics_out
            ...
            Array[
            File?
            ]? indv_s_bkbam = indv_mapping.bklist_bam
            ...
            Array[
            File?
            ]? indv_s_rmbam = indv_mapping.mkdup_bam
