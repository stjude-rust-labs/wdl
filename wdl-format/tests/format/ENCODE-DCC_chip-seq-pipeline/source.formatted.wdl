...
workflow chip {
    ...
    String aligner_ = (
        if defined(custom_align_py) then "custom" else aligner)
    ...
    Array[
        Array[File]] fastqs_R1 = (if length(fastqs_rep10_R1) > 0 then [
        fastqs_rep1_R1,
        fastqs_rep2_R1,
        fastqs_rep3_R1,
        fastqs_rep4_R1,
    ...
    Array[
        Array[File]] ctl_fastqs_R1 = (if length(ctl_fastqs_rep10_R1) > 0 then [
        ctl_fastqs_rep1_R1,
        ctl_fastqs_rep2_R1,
        ctl_fastqs_rep3_R1,
        ctl_fastqs_rep4_R1,
        ...
        if (pipeline_type == "control" && num_rep_fastq == 0) {
            ...
            scatter (i in range(num_rep)) {
                                ...
                                Boolean paired_end_ = (
                                    ...
                                    paired_ends) then paired_ends[i] else select_first([
                                    paired_end,
                                ]))
                                ...
                                if (has_input_of_align && !has_output_of_align) {
                                    call align { input:
                                        ...
                                        fastqs_R2 = (
                                            if paired_end_ then fastqs_R2[i] else []),
                                ...
                                File? bam_ = (
                                    if has_output_of_align then bams[i] else align.bam)
                                ...
                                File? ta_ = (
                                    if has_output_of_bam2ta then tas[i] else bam2ta.ta)

                                Boolean has_input_of_spr = has_output_of_bam2ta || defined(
                                    bam2ta.ta)
                                ...
                                if (
                                    ...
                                    Int? fraglen_ = (
                                        if i < length(
                                        fraglen) then fraglen[i] else xcor.fraglen)
                                }
                                ...
                                scatter (
                                    i in range(num_ctl)) {
                                                            ...
                                                            Boolean has_output_of_align_ctl = i < length(
                                                                ctl_bams)
                                                            ...
                                                            if (
                                                                has_input_of_align_ctl && !has_output_of_align_ctl
                                                                    ...
                                                                    Boolean has_output_of_filter_ctl = i < length(
                                                                        ctl_nodup_bams)
                                                                    ...
                                                                    if (
                                                                        ...
                                                                        Boolean has_output_of_bam2ta_ctl = i < length(
                                                                            ctl_tas)
