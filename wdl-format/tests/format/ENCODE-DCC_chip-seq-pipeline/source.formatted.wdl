...
num_rep
        ...
        Boolean paired_end_ = (
            ...
            Boolean has_output_of_align = i < length(
            bams
            )
    ...
    Boolean has_output_of_filter = i < length(
    nodup_bams
    )
...
Boolean has_output_of_bam2ta = i < length(
tas
)
...
File? ta_xcor = (
    ...
    Boolean paired_end_xcor = (
        ...
        Boolean has_input_of_xcor = defined(
        ta_xcor
        )
