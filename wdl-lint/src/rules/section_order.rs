                ...
                _ => {
                    state.exceptable_add(
                        task_section_order(
                            task.name().span(),
                            task.name().as_str(),
                            item.syntax().first_token().expect("task item should have tokens").text_range().to_span(),
                        ),
                ...
                _ => {
                    state.exceptable_add(
                        workflow_section_order(
                            ...
                            item.syntax().first_token().expect("workflow item should have tokens").text_range().to_span(),
                        ),
