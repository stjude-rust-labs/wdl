...
fn it_successfully_parses_an_empty_double_quoted_string() {
    parses_to! {
        ...
        input: "\"\"",
        rule: Rule::literal,
        tokens: [literal(0, 2, [double_quoted_string(0, 2)])]
    }
}
...
fn it_successfully_parses_an_empty_single_quoted_string() {
    parses_to! {
        ...
        input: "''",
        rule: Rule::literal,
        tokens: [literal(0, 2, [single_quoted_string(0, 2)])]
    }
}
...
fn it_successfully_parses_a_double_quoted_string_with_a_unicode_character() {
    parses_to! {
        ...
        input: "\"😀\"",
        rule: Rule::literal,
        tokens: [literal(0, 6, [double_quoted_string(0, 6)])]
    }
}
...
fn it_successfully_parses_a_single_quoted_string_with_a_unicode_character() {
    parses_to! {
        ...
        input: "'😀'",
        rule: Rule::literal,
        tokens: [literal(0, 6, [single_quoted_string(0, 6)])]
    }
}
...
fn it_successfully_parses_a_double_quoted_string() {
    parses_to! {
        ...
        input: "\"Hello, world!\"",
        rule: Rule::literal,
        tokens: [literal(0, 15, [double_quoted_string(0, 15)])]
    }
}
...
fn it_successfully_parses_a_single_quoted_string() {
    parses_to! {
        ...
        input: "'Hello, world!'",
        rule: Rule::literal,
        tokens: [literal(0, 15, [single_quoted_string(0, 15)])]
    }
}
