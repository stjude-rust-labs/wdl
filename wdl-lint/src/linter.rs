...
/// The state of the linting visitor.
#[allow(missing_debug_implementations)]
pub struct LintState {
    /// The diagnostics generated by the visitor.
...
impl LintState {
    ...
    pub fn add(&mut self, diagnostic: wdl_ast::Diagnostic) {
        self.diagnostics.add(diagnostic);
    }

    /// Adds a diagnostic to the state with an exceptable node.
    pub fn exceptable_add(
        ...
        self.diagnostics.exceptable_add(diagnostic, element, exceptable_nodes);
    }
}
...
impl Linter<()> {
    ...
    fn each_enabled_rule<F>(&mut self, state: &mut LintState, mut cb: F)
    where
        F: FnMut(&mut LintState, &mut dyn Rule),
    {
