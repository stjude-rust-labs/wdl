        ...
        for node in node.into_inner() {
            match node.as_rule() {
                Rule::metadata_kv => {
                    ...
                    let key_node =
                        extract_one!(node.clone(), metadata_key, metadata_kv, Error::Common)?;
                    let location =
                    ...
                    let value_node =
                        extract_one!(node, metadata_value, metadata_kv, Error::Common)?;
                    let location =
