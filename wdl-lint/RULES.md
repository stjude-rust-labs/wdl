...
| `MixedIndentation` | Clarity, Correctness, Spacing | Ensures that lines within a document do not mix spaces and tabs. Command sections emit warnings, other sections emit notes. |
