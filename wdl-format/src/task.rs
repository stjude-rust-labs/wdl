...
impl Formattable for CommandSection {
    fn format<T: std::fmt::Write>(&self, writer: &mut T, state: &mut State) -> std::fmt::Result {
        ...
        let command_keyword = first_child_of_kind(self.syntax(), SyntaxKind::CommandKeyword);
        state.indent(writer)?;
...
impl Formattable for RuntimeSection {
    fn format<T: std::fmt::Write>(&self, writer: &mut T, state: &mut State) -> std::fmt::Result {
        ...
        let runtime_keyword = first_child_of_kind(self.syntax(), SyntaxKind::RuntimeKeyword);
        state.indent(writer)?;
...
impl Formattable for TaskDefinition {
    fn format<T: std::fmt::Write>(&self, writer: &mut T, state: &mut State) -> std::fmt::Result {
        ...
        let task_keyword = first_child_of_kind(self.syntax(), SyntaxKind::TaskKeyword);
        state.indent(writer)?;
