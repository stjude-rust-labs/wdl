...
* A JavaScript file can be provided that will be read and have its contents embedded in the `<head>` tag of each page ([#591](https://github.com/stjude-rust-labs/wdl/pull/591)).
